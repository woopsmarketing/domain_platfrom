          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <ul className="flex flex-col items-center gap-1.5">
              {[
                ...
                <li
                  key={item}
                  className="inline-flex items-center gap-2 text-sm sm:text-base text-muted-foreground"
                >
            ...
            >
              <Button
                variant="default"
                size="lg"
                className="w-full sm:w-auto whitespace-nowrap bg-emerald-600 hover:bg-emerald-700 h-14 px-10 text-base sm:text-lg font-semibold shadow-md"
              >
