...
export default async function DomainDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      {/* SEO 대행 — 텔레그램 상담 CTA (우선 노출) */}
      <Card className="mt-6 border-emerald-500/40 bg-gradient-to-r from-emerald-500/10 to-teal-500/15 shadow-sm">
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-base sm:text-lg text-foreground/80 leading-relaxed">
                블랙키워드 · 고난이도 키워드 전문 <span className="font-semibold text-emerald-700">9년차</span> — 노출 보장형 실행사 SEO를 직접 상담받아보세요.
              </p>
              <ul className="flex flex-col gap-2 mt-1">
                {[
                  ...
                  <li key={item} className="flex items-center gap-2 text-base sm:text-lg text-foreground/85 font-medium">
            ...
            <div className="shrink-0">
              ...
              >
                <Button
                  variant="default"
                  size="lg"
                  className="w-full sm:w-auto whitespace-nowrap bg-emerald-600 hover:bg-emerald-700 h-14 px-8 text-base sm:text-lg font-semibold shadow-md"
                >
