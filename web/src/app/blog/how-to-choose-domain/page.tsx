...
export default function HowToChooseDomainPage() {
  return (
    <BlogLayout
      ...
      readTime="5분"
      toc={[
        { id: "intro", title: "도메인 선택이 투자 수익을 결정한다" },
        { id: "da-dr", title: "1. DA/DR 점수가 높은 도메인" },
        { id: "tld", title: "2. 프리미엄 TLD" },
        { id: "domain-age", title: "3. 도메인 나이" },
        { id: "backlink", title: "4. 건전한 백링크 프로필" },
        { id: "brandability", title: "5. 브랜드 가능성" },
        { id: "tld-comparison", title: "TLD별 가치 비교표" },
        { id: "checklist", title: "도메인 구매 전 체크리스트 10가지" },
        { id: "avoid", title: "피해야 할 도메인 유형" },
        { id: "faq", title: "자주 묻는 질문" },
      ]}
      faqs={[
        {
          q: "도메인 투자 초보자는 어떤 도메인부터 시작해야 하나요?",
          a: "초보자는 .com TLD의 짧은 키워드 도메인부터 시작하는 것을 추천합니다. DA 15~30 범위의 만료 도메인 중 스팸 점수가 낮은 도메인을 $50~$200 사이에서 구매하여 경험을 쌓은 후 점차 규모를 키워가는 것이 안전합니다.",
        },
        {
          q: "도메인 가치는 어떻게 평가하나요?",
          a: "도메인 가치는 DA/DR 같은 SEO 지표, TLD 종류, 도메인 길이, 키워드 포함 여부, 백링크 품질, 브랜드 가능성을 종합적으로 평가합니다. 도메인체커에서 이러한 지표를 무료로 확인할 수 있습니다.",
        },
        {
          q: ".com 도메인이 정말 다른 TLD보다 가치가 높은가요?",
          a: "네, 일반적으로 .com은 다른 TLD 대비 2~10배 높은 가격에 거래됩니다. 가장 오래된 TLD로 사용자 신뢰도가 가장 높고, 전 세계적으로 통용되기 때문입니다. 다만 .io, .ai 등 특정 산업에서 프리미엄 대우를 받는 TLD도 있습니다.",
        },
        {
          q: "만료 도메인과 경매 도메인의 차이는 무엇인가요?",
          a: "만료 도메인은 소유자가 갱신하지 않아 등록 기간이 끝난 도메인이고, 경매 도메인은 소유자가 자발적으로 매각을 위해 올린 도메인입니다. 만료 도메인은 비교적 저렴하지만 스팸 이력 확인이 필수이고, 경매 도메인은 가격이 높지만 상태가 양호한 경우가 많습니다.",
        },
        {
          q: "도메인 나이가 정말 SEO에 영향을 주나요?",
          a: "도메인 나이 자체가 직접적인 랭킹 팩터는 아니지만, 오래된 도메인은 대개 더 많은 백링크와 검색엔진 신뢰도를 축적하고 있습니다. 5년 이상 된 도메인은 새 도메인보다 검색 순위 진입이 빠른 경향이 있습니다.",
        },
      ]}
      cta={{
        title: "관심 도메인의 지표를 확인해 보세요",
        description:
