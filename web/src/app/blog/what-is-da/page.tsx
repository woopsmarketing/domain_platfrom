...
export default function WhatIsDaPage() {
  return (
    <BlogLayout
      ...
      readTime="4분"
      toc={[
        { id: "what-is-da", title: "DA란 무엇인가?" },
        { id: "how-da-calculated", title: "DA는 어떻게 계산되나?" },
        { id: "why-da-matters", title: "도메인 투자에서 DA가 중요한 이유" },
        { id: "da-score-table", title: "DA 점수 등급표" },
        { id: "how-to-improve-da", title: "DA를 높이는 방법" },
        { id: "da-vs-dr-tf", title: "DA vs DR vs TF 비교" },
        { id: "da-cautions", title: "DA 확인 시 주의사항" },
        { id: "faq", title: "자주 묻는 질문" },
      ]}
      faqs={[
        {
          q: "DA 점수가 높으면 무조건 좋은 도메인인가요?",
          a: "DA 점수가 높다고 무조건 좋은 도메인은 아닙니다. 스팸 백링크로 인위적으로 DA를 올린 경우도 있으므로, 반드시 스팸 점수와 백링크 품질을 함께 확인해야 합니다. DA는 여러 품질 지표 중 하나로 참고하는 것이 올바른 활용법입니다.",
        },
        {
          q: "DA는 얼마나 자주 업데이트되나요?",
          a: "DA 점수는 보통 월 1~2회 업데이트됩니다. 웹 크롤러가 새로운 백링크 데이터를 수집하고 인덱싱한 후 점수에 반영하기 때문에, 실시간 변동이 아닌 주기적인 업데이트 방식입니다.",
        },
        {
          q: "새 도메인의 DA는 몇 점인가요?",
          a: "새로 등록한 도메인의 DA는 1점에서 시작합니다. 백링크가 전혀 없는 상태이므로 최저 점수가 부여되며, 양질의 콘텐츠를 게시하고 자연스러운 백링크를 확보하면서 점차 올라갑니다.",
        },
        {
          q: "DA를 빨리 올리는 방법이 있나요?",
          a: "DA를 단기간에 급격히 올리는 정당한 방법은 없습니다. 유료 링크 구매나 PBN(Private Blog Network)은 오히려 스팸 점수를 높이고 검색엔진 패널티를 받을 수 있습니다. 양질의 콘텐츠 제작, 자연스러운 백링크 확보, 기술적 SEO 최적화를 꾸준히 하는 것이 유일한 방법입니다.",
        },
        {
          q: "DA와 PA의 차이는 무엇인가요?",
          a: "DA(Domain Authority)는 도메인 전체의 권위도를, PA(Page Authority)는 개별 페이지의 권위도를 측정합니다. DA가 높은 도메인에서도 특정 페이지의 PA는 낮을 수 있으며, 그 반대도 가능합니다. 도메인 투자에서는 주로 DA를 기준으로 평가합니다.",
        },
      ]}
      cta={{
        title: "도메인의 DA를 확인해 보세요",
        description:
