...
export default function DomainAuctionGuidePage() {
  return (
    <BlogLayout
      ...
      readTime="6분"
      toc={[
        { id: "what-is-auction", title: "도메인 경매란?" },
        { id: "platform-comparison", title: "경매 플랫폼 비교표" },
        { id: "bidding-strategy", title: "입찰 전략 가이드" },
        { id: "after-winning", title: "낙찰 후 절차 4단계" },
        { id: "using-data", title: "도메인체커 낙찰 데이터 활용법" },
        { id: "faq", title: "자주 묻는 질문" },
      ]}
      faqs={[
        {
          q: "도메인 경매에서 낙찰받으면 바로 사용할 수 있나요?",
          a: "낙찰 후 바로 사용할 수는 없습니다. 결제 완료 후 도메인 이전(transfer) 절차가 필요하며, 보통 3~7일 정도 소요됩니다. 이전이 완료되면 DNS 설정을 변경하여 원하는 용도로 사용할 수 있습니다.",
        },
        {
          q: "경매에서 입찰 후 취소할 수 있나요?",
          a: "대부분의 경매 플랫폼에서 입찰은 취소할 수 없습니다. 입찰은 구매 의사를 법적으로 표시하는 행위이므로, 최고 입찰자가 되면 반드시 결제해야 합니다. 미결제 시 계정 정지 등의 페널티가 부과될 수 있습니다.",
        },
        {
          q: "경매 수수료는 얼마인가요?",
          a: "플랫폼마다 다릅니다. GoDaddy Auctions는 연간 멤버십 $4.99 + 거래 수수료(구매자 무료~$20), Namecheap은 별도 수수료 없이 낙찰가로 구매 가능, Dynadot는 일부 경매에서 5~10% 수수료가 부과됩니다.",
        },
        {
          q: "만료 도메인 경매와 사용자 등록 경매의 차이는 무엇인가요?",
          a: "만료 도메인 경매는 소유자가 갱신하지 않아 등록 기간이 끝난 도메인이 자동으로 경매에 올라오는 것이고, 사용자 등록 경매는 소유자가 자발적으로 도메인을 매각하기 위해 올린 것입니다. 만료 도메인은 보통 낮은 시작가에서 시작하며, 사용자 등록 경매는 소유자가 원하는 가격을 설정합니다.",
        },
        {
          q: "도메인 경매에서 좋은 도메인을 찾는 팁이 있나요?",
          a: "도메인체커의 낙찰 이력 페이지에서 최근 거래 트렌드를 파악하고, 대량 분석 도구로 여러 후보 도메인의 SEO 지표를 한 번에 비교하세요. DA 20 이상, 스팸 점수 30% 미만, .com TLD인 도메인을 우선적으로 검토하면 실패 확률을 크게 줄일 수 있습니다.",
        },
      ]}
      cta={{
        title: "경매 도메인의 가치를 분석해 보세요",
        description:
